...
<body>
    ...
    <div class="table_container">        
        ...
        $sql = "SELECT * FROM user_form WHERE user_type ='host' && status = 'Approved' ";
        if ($result = mysqli_query($conn, $sql)) {
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<td>";
                    echo '<a href="suspend_host_request.php?id=' . $row['id'] . '" class ="suspend">Suspend</a>';
                    echo "</td>";
                    echo "<td>";
                    echo '<a href="delete.php?id=' . $row['id'] . '" class="reject">Delete</a>';
                    echo "</td>";
                    echo "</tr>";
                }
                echo "</tbody>";
